...
@section('content')
            ...
            <div class="ui small modal" id="importmodal">
                ...
                <div class="header">
                    ...
                    {{ Form::open(array('url' => '/services/import', 'class' => 'ui form active tab column', 'files' => true,  'method' => "post", 'enctype' => "multipart/form-data", 'id' => 'importform')) }}
                <div class="content">
                    ...
                    <div class="six wide column">
                        <div class="content-header-button">
                            <div class="header-controls">
                                {{ Form::open(array('url' => '/export/3', 'class' => '', 'enctype' => 'multipart/form-data')) }}
                                ...
                                {{ Form::hidden('hdnfilters', null, array('id' => 'hdnfilters')) }}
                                    ...
                                    <a class="ui green button import-toggle" data-mode="3">
                                        Import
                                    </a>
                                {{ Form::close() }}
                            </div>
