...
@section('content')
            ...
            <div class="ui small modal" id="importmodal">
                ...
                <div class="header">
                    ...
                    {{ Form::open(array('url' => '/inventory/import', 'class' => 'ui form active tab column', 'files' => true,  'method' => "post", 'enctype' => "multipart/form-data", 'id' => 'importform')) }}
                <div class="content">
                    ...
                    <div class="six wide column">
                        <div class="content-header-button">
                            <div class="header-controls">
                                {{ Form::open(array('url' => '/export/2', 'class' => '', 'enctype' => 'multipart/form-data')) }}
                                ...
                                <a class="ui green button import-toggle" data-mode="2">
                                    Import
                                </a>
                                {{ Form::close() }}
                            </div>
